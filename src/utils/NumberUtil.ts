...
export const BN = (Web3.utils as any).BN;
...
export const humanize = (bn: any, bnPrecision: number | undefined, targetPrecision: number | undefined, format: boolean, minDecimals: number) => {
  if (typeof bn === 'number') {
    bn = new BN(bn);
...
export const fromDecimalToBN = (value: number | string, bnPrecision: number | undefined) => {
